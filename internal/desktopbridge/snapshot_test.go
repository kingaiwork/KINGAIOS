...
func TestBuildPrivateSnapshotDropsRawTaskStepData(t *testing.T) {
	...
	for _, forbidden := range []string{"private step title", "filesystem.write", "/home/user/private-output", "approval-private", "step-result-secret", "peer_uid", "target", "capability", "approval_id", "result"} {
